      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-2">
            ...
            <HelpDialog 
              moduleKey="trip_management"
              title="Marine Order 504 (2024)"
              defaultContent="Operational procedures must align with assessed risks, including voyage planning, safety of navigation, and crew allocation per SMS requirements."
