...
const Emergency = () => {
  ...
  const allEmergencyWorksheets = [
    ...
    {
      name: 'Procedures',
      columns: ['Title', 'Emergency Type', 'Purpose', 'Procedure Steps', 'Equipment Required', 'Muster Station', 'Key Contacts', "Master's Guidance Notes", 'Reference Documents'],
  ...
  const exportProceduresToExcel = () => {
    ...
    const wb = XLSX.utils.book_new();
    const headers = ['Title', 'Emergency Type', 'Procedure Steps', 'Equipment Required', 'Muster Station', 'Key Contacts', "Master's Guidance Notes", 'Reference Documents'];
    ...
    const ws = XLSX.utils.aoa_to_sheet(data);
    ws['!cols'] = [{ wch: 25 }, { wch: 18 }, { wch: 50 }, { wch: 25 }, { wch: 20 }, { wch: 25 }, { wch: 30 }, { wch: 30 }];
  ...
  const exportAllEmergencyToExcel = () => {
    ...
    // Sheet 2: Procedures
    const proceduresHeaders = ['Title', 'Emergency Type', 'Procedure Steps', 'Equipment Required', 'Muster Station', 'Key Contacts', "Master's Guidance Notes", 'Reference Documents'];
    ...
    wsProcedures['!cols'] = [{ wch: 25 }, { wch: 18 }, { wch: 50 }, { wch: 25 }, { wch: 20 }, { wch: 25 }, { wch: 30 }, { wch: 30 }];
