...
import { Shield, Plus, AlertTriangle, CheckCircle, Clock, Search, Filter, X, Download, ChevronDown, Edit, Trash2, Info, FileSpreadsheet, Upload, FileText, ExternalLink } from 'lucide-react';
            ...
            <Tooltip>
              ...
              <TooltipContent className="max-w-sm">
                ...
                <p className="text-sm mb-2">
                  Ensures SMS compliance, certificate validity, documented procedures, and regulatory adherence for vessel operations and crew qualifications.
                </p>
                <a 
              ...
              {certForm.pdf_url ? (
                <div className="flex items-center gap-3 p-3 border rounded-lg bg-gray-50 mt-2">
                  ...
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    onClick={() => setCertForm({...certForm, pdf_url: ''})}
                  >
                ...
                <div 
                  className={`border-2 border-dashed rounded-lg p-4 text-center cursor-pointer hover:border-gray-400 transition-colors mt-2 ${uploadingPdf ? 'opacity-50' : ''}`}
                  onClick={() => !uploadingPdf && document.getElementById('cert-pdf-upload').click()}
                >
                  <input
                    id="cert-pdf-upload"
                    type="file"
