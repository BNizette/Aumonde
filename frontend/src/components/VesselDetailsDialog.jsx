  ...
  const renderContent = () => {
    switch (selectedView) {
      ...
      case 'running':
        ...
        ) : <p className="text-gray-500 text-center py-8">No running logs recorded for this vessel.</p>;
      case 'engine':
        return engineLogs.length > 0 ? (
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead>Date & Time</TableHead>
        ...
        ) : <p className="text-gray-500 text-center py-8">No engine logs recorded for this vessel.</p>;
      case 'drills':
        ...
        ) : <p className="text-gray-500 text-center py-8">No drill logs recorded for this vessel.</p>;
      case 'risks':
