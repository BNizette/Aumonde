      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <Tabs defaultValue="basic" className="w-full">
          ...
          <ScrollArea className="h-[400px] w-full pr-4">
            ...
            {/* TAB: SAFETY INDUCTION */}
            <TabsContent value="induction" className="space-y-4">
              {mode === 'edit' ? (
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="text-lg font-semibold">Safety Induction Training</h3>
                      <p className="text-sm text-gray-500">Track crew induction completion for this vessel</p>
                    </div>
                  </div>
                  ...
                  {loadingInduction ? (
                    ...
                    <div className="text-center py-8 text-gray-500">
                      ...
                      <p className="text-xs mt-1">Configure tasks in Admin Panel → Settings → Vessel Management → Safety Induction Tasks</p>
                    </div>
                  ) : crewList.length === 0 ? (
                    ...
                    <div className="space-y-4">
                      {crewList.map(crew => {
                        ...
                        const completionPercent = inductionTasks.length > 0 
                          ? Math.round((completedTasks.length / inductionTasks.length) * 100) 
                          : 0;
                        ...
                        return (
                          <div key={crew.id} className="border rounded-lg p-4">
                            <div className="flex items-center justify-between mb-3">
                              <div>
                                <span className="font-medium">{crew.staff_name}</span>
                                <span className="text-sm text-gray-500 ml-2">({crew.default_position || 'No position'})</span>
                              </div>
                              <div className="flex items-center gap-2">
                                <div className="w-24 h-2 bg-gray-200 rounded-full overflow-hidden">
                                  <div 
                                    className={`h-full ${completionPercent === 100 ? 'bg-green-500' : 'bg-blue-500'}`}
                                  ...
                                  >
                                    <input
                                      ...
                                      onChange={(e) => {
                                        ...
                                        handleInductionUpdate(crew.id, crew.staff_name, newTasks);
                                      }}
                                      className="rounded"
                                    />
                ...
                <div className="text-center py-8 text-gray-500">
                  <p>Safety induction training will be available after creating the vessel</p>
                </div>
              )}
            </TabsContent>
